...
class MyServer(BaseHTTPRequestHandler):
    """
        Специальный класс, который отвечает за обработки
    ...
    def do_GET(self):
        ...
        """Методо для входящий GET-запросов"""
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Корректный способ остановить сервер в консоли через сочетания клавиш Ctrl + C
        pass
